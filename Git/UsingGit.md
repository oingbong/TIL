...
<kbd><img src="../Img/git3.png" width="250" height="250"></kbd>
...
<kbd><img src="../Img/git5.png" width="250" height="250"></kbd>

### 파일 만들기
	6. vim (File Name)
	 - 처음 들어갔을 때 아무 것도 보이지 않습니다.

<kbd><img src="../Img/git6.png" width="250" height="250"></kbd>

	7. i
	 - i 를 누르면 밑에 상태창이 -- INSERT -- 로 변경 (입력 가능한 상태)
	 - 내용 입력

<kbd><img src="../Img/git7.png" width="250" height="250"></kbd>

	8. 'ESC' 키 누른 후 :wq
	 - ESC 버튼으로 입력 상태를 나오고 :wq 명령어로 파일 내용 저장 및 닫기

<kbd><img src="../Img/git8.png" width="250" height="250"></kbd>
...
<kbd><img src="../Img/git9.png" width="250" height="250"></kbd>
...
<kbd><img src="../Img/git10.png" width="250" height="250"></kbd>

	11. git config --global user.name "User Name"
	12. git config --global user.email "User Email"

<kbd><img src="../Img/git12.png" width="250" height="250"></kbd>
...
<kbd><img src="../Img/git13-1.png" width="250" height="250"></kbd>

	 - 커밋이 완료되면 다음과 같은 메세지가 나옵니다.

<kbd><img src="../Img/git13-2.png" width="250" height="250"></kbd>

	14. git log
	 - 지금까지 작업했던 git log 를 볼 수 있습니다.
	 - commit ~ 내용은 식별자 같은 것입니다.

<kbd><img src="../Img/git14.png" width="250" height="250"></kbd>
...
<kbd><img src="../Img/git16.png" width="250" height="250"></kbd>

	17. git push
	 - 이 명령어를 사용한다면 master Branch 를 설정하라는 메세지가 나옵니다.

<kbd><img src="../Img/git17.png" width="250" height="250"></kbd>

	18. git push origin master
	 - github ID, PWD 입력
	 - 계정 확인 후 다음과 같은 메세지가 나오면 성공

<kbd><img src="../Img/git18-1.png" width="250" height="250"></kbd>

	 - github 페이지 확인

<kbd><img src="../Img/git18-2.png" width="250" height="250"></kbd>
